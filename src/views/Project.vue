<template>
    <main class="overflow-x-hidden min-h-[100vh] lg:px-10 max-sm:px-3 pb-5">
        <h1 class="lg:text-2xl lg:mt-[4.5rem] max-sm:mt-[4rem] lg:mb-5 max-sm:mb-4 uppercase font-bold">My <span
